...
# Source0-md5:	55d07fa085c72b8cdaf186121f0c5413
...
OpenJDK components including the OpenJDK, Java 11 developement kit and
runtime environment.

%description -l pl.UTF-8
Wolnoźródłowa implementacja Java 11 SE.
...
Obsoletes:	jdk
Obsoletes:	kaffe
Obsoletes:	openjdk11-jdk < 11.0.31
Obsoletes:	oracle-java7
...
Provides:	jdk(%{name})
Obsoletes:	openjdk11-jdk-base < 11.0.31
...
Obsoletes:	jre
Obsoletes:	jsse
Obsoletes:	openjdk11-jre < 11.0.31
Obsoletes:	oracle-java7-jre
...
Provides:	jre(%{name})
Obsoletes:	openjdk11-jre-base < 11.0.31
...
Obsoletes:	openjdk11-jre-base-X11 < 11.0.31
...
Obsoletes:	openjdk11-jre-base-freetype < 11.0.31
...
Obsoletes:	jar
Obsoletes:	openjdk11-jar < 11.0.31
